...
public interface SalesListContract {
    ...
    interface View extends PagerView<Presenter> {
         ...
         * {@link com.example.Postoko.storeapp.ui.inventory.config.SalesConfigActivity}
    ...
    interface Presenter extends PagerPresenter {
         ...
         * {@link com.example.Postoko.storeapp.data.local.contracts.ProductContract.Product#CONTENT_URI}
         */
