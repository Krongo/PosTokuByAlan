...
package com.example.Postoko.storeapp.data.local.utils;
...
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.AND;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.AS;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.CLOSE_BRACE;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.COUNT;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.DESC;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.EQUALS;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.IS;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.JOIN;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.LEFT_JOIN;
...
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.OR;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.PLACEHOLDER;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.SUM;
