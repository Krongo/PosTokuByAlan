...
public class ProductContract implements StoreContract {
    ...
    public static final class Product implements BaseColumns {
         ...
         * 'vnd.android.cursor.dir/com.example.Postoko.storeapp.provider.item
         */
         ...
         * 'vnd.android.cursor.item/com.example.Postoko.storeapp.provider.item
         */
         ...
         * 'vnd.android.cursor.dir/com.example.Postoko.storeapp.provider.item.short
         */
         ...
         * 'vnd.android.cursor.item/com.example.Postoko.storeapp.provider.item.sku
         */
    ...
    public static final class ProductCategory implements BaseColumns {
         ...
         * 'vnd.android.cursor.dir/com.example.Postoko.storeapp.provider.category
         */
        public static final String CONTENT_LIST_TYPE
         ...
         * 'vnd.android.cursor.item/com.example.Postoko.storeapp.provider.category
         */
        public static final String CONTENT_ITEM_TYPE
    ...
    public static final class ProductImage implements BaseColumns {
         ...
         * 'vnd.android.cursor.dir/com.example.Postoko.storeapp.provider.item.image
         */
        public static final String CONTENT_LIST_TYPE
         ...
         * 'vnd.android.cursor.item/com.example.Postoko.storeapp.provider.item.image
         */
        public static final String CONTENT_ITEM_TYPE
    ...
    public static final class ProductAttribute implements BaseColumns {
         ...
         * 'vnd.android.cursor.dir/com.example.Postoko.storeapp.provider.item.attr
         */
        public static final String CONTENT_LIST_TYPE
                = ContentResolver.CURSOR_DIR_BASE_TYPE
         ...
         * 'vnd.android.cursor.item/com.example.Postoko.storeapp.provider.item.attr
         */
        public static final String CONTENT_ITEM_TYPE
                = ContentResolver.CURSOR_ITEM_BASE_TYPE
                + "/" + CONTENT_AUTHORITY + "." + PATH_ITEM + "." + PATH_ITEM_ATTR;
