...
import com.example.Postoko.storeapp.data.local.contracts.ProductContract.Product;
import com.example.Postoko.storeapp.data.local.contracts.ProductContract.ProductAttribute;
import com.example.Postoko.storeapp.data.local.contracts.ProductContract.ProductCategory;
import com.example.Postoko.storeapp.data.local.contracts.ProductContract.ProductImage;
import com.example.Postoko.storeapp.data.local.contracts.SalesContract.ProductSupplierInfo;
import com.example.Postoko.storeapp.data.local.contracts.SalesContract.ProductSupplierInventory;
import com.example.Postoko.storeapp.data.local.contracts.SupplierContract.Supplier;
import com.example.Postoko.storeapp.data.local.contracts.SupplierContract.SupplierContact;
import com.example.Postoko.storeapp.data.local.contracts.SupplierContract.SupplierContactType;
import com.example.Postoko.storeapp.utils.AppConstants;
import com.example.Postoko.storeapp.utils.AppExecutors;

import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.CLOSE_BRACE;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.COMMA;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.CONFLICT_FAIL;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.CONFLICT_REPLACE;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.CONSTRAINT;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.CREATE_INDEX;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.CREATE_TABLE;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.DEFAULT;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.DELETE_CASCADE;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.FOREIGN_KEY;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.INTEGER;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.NOT;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.NULL;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.ON;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.OPEN_BRACE;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.PRIMARY_KEY;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.PRIMARY_KEY_AUTOINCREMENT;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.REAL;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.REFERENCES;
import static com.example.Postoko.storeapp.data.local.utils.SqliteUtility.SPACE;
